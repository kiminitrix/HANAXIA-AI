    ...
    <>
      ...
      <aside 
        className={`
          ...
          w-72 bg-[#0f0f11] border-r border-white/5
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-white/5">
           <div className="flex items-center gap-3">
             ...
             <span className="font-bold text-lg tracking-wide text-white">HANAXIA</span>
           </div>
        ...
        <div className="p-4">
          <button 
             ...
             className="w-full py-3 px-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-white font-medium flex items-center justify-center gap-2 transition-colors"
          >
        ...
        <div className="p-4 border-t border-white/5 bg-[#0a0a0c]">
           <div className="flex items-center gap-3">
              ...
              <div>
                 <div className="text-sm font-medium text-white">Master Kimi</div>
                 <div className="text-xs text-purple-400">Pro Plan</div>
              </div>
           </div>
        </div>
      </aside>
